...
Overseer is a lightweight Flask dashboard for viewing and controlling containers through the Docker Engine API.
...
For a short product overview and usage example, see the repository-level [`README.md`](../README.md).
